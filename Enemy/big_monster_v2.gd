...
func _on_enemy_ready() -> void:
	...
	# Appliquer les valeurs spécifiques au BigMonster V2
...
func _on_damage_taken(_damage: int) -> void:
	# Aucune réaction spécifique aux dégâts pour le BigMonster V2
	pass
...
# === MÉTHODES SPÉCIFIQUES AU BIG MONSTER V2 ===

func get_impact_colors() -> Array[Color]:
	# Retourner les 4 couleurs d'impact du BigMonster V2 (tons violet/gris)
